...
// HTML. It's a <div role="button"> instead; App.tsx's global click-sound
// listener is extended to match `.tingxie-flip-card` alongside
// `button`/`.option-label` so it still gets the app-wide click sound.
