// Animates a clone of an emoji flying from a Bag item card to the owl art,
...
export function throwToOwl(sourceEl: HTMLElement, targetEl: HTMLElement, emoji: string, onArrive: () => void): void {
